...
Note, once you have completed this code chunk, you should have a new data frame that has ONE value per sampleID (each sampleID represents a microhabitat sampled on a particular day). You will then use this new data frame going forward.
